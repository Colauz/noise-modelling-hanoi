...
\begin{figure}[htbp]
  ...
  is the frame, Hanoi's 51 urban \emph{phuong} under the July~2025 reform,
  407\,km$^2$, against the 1.7\,km$^2$ the campaign has actually covered, a
  factor of 236. Boundaries are OpenStreetMap
...
Frame area, measured area, the 236$\times$ ratio, and which areas fall inside
