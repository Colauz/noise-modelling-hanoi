...
%
%  TARGET VENUE: [TO CONFIRM]. Nothing in the project repository names AAMAS or
%  any other venue. The layout below is a neutral two-column A4 article; if the
...
\author{%
  ...
  {\small ISIMA, Clermont-Ferrand, France ---
   \tc{host laboratory: CEI or COSMOS Lab}, VinUniversity, Hanoi}\\
...
contribution is not a noise map of Hanoi --- our instrument cannot support one
--- but a set of \textbf{boundary conditions on low-cost urban noise modelling},
...
the two strict protocols. Constraining its capacity recovers part of the loss ---
and the direction of that trade is the diagnosis: what the unconstrained residual
...
and has no term in any of our models. \tc{whether the discontinuity is diagnosed
before submission}.
...
which models what a distance law cannot: diffraction around buildings and
...
\paragraph{Acknowledgements.} \tc{supervisor's title, host laboratory, and
whether Nguyen Thanh Quang appears here or in the byline}.
